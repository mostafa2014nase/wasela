...
import 'package:wasela/clients_app/app_layouts/main_layouts/app_layouts/calculate_charge/padge_two.dart';
                  ...
                  inkwellFunc: () {
                    navigateAndBack(context,
                        layout: CalculateChargeSecondScreen(
                          fromCity: cubit.selectedPosition,
                          toCity: cubit.selectedCity,
                        ));
                  },
