...
import 'package:wasela/clients_app/app_layouts/main_layouts/app_layouts/charge/bloc/cubit_class.dart';
...
class ChargeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ChargeCubitClass(),
      child: BlocConsumer<ChargeCubitClass, ChargeStates>(
